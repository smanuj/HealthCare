...
public interface DoctorDetailsRepository extends JpaRepository<DoctorDetails, Integer> {
	...
	DoctorDetails findBySpecializationAndAvaliabilityTrue(String specialization);

	List<DoctorDetails> findAllBySpecializationAndAvaliabilityTrue(String specialization);
